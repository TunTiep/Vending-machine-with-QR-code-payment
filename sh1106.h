 ...
 * 
 * The SH1106 controller is similar to SSD1306 but has different memory organization
 * and command set. It supports 128x64 resolution displays.
 * 
 * Default pinout
 ...
 * @param  i: 1 for inverted, 0 for normal
 * @retval None
 */
...
/**
 * @brief  Display "Hello World" example function
 * @note   This is a convenient function to test the display
 * @retval None
 */
